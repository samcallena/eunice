document.addEventListener('DOMContentLoaded', () => {
    ...
    // Function para mag-play ng sound effects nang walang delay
    function playSound(audioEl) {
        audioEl.currentTime = 0;
        audioEl.play().catch(e => console.log("SFX blocked"));
    }
    
    // 1. Photo Memory Database - May iPhone Emojis at Eksaktong Hinihiling na Mensahe
    const memoryData = {
        queen: {
            title: "💖 I",
    ...
    // Attach click events sa lookbook photo cards
    ...
    // 2. Background Ambiance Sparkles
        ...
        btn.addEventListener('click', () => {
            ...
            if (clickedItems.size === 3) {
                setTimeout(() => {
                    ...
                    gameZone.innerHTML = "<h3>🎉 UNLOCKED! 🎉</h3><p>Buksan mo na ang iyong interactive gift box sa ibaba para lumabas ang sweet message! 🎁👇</p>";
    ...
    // 4. Opening Gift Box -> Opens full screen Sweet Letter Pop-out
